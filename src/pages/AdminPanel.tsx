...
import { CheckCircle, XCircle, Clock, Shield, Loader2, Phone, FileText, Camera, Briefcase } from "lucide-react";
...
const AdminPanel = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO title="Admin Panel" description="Review verification requests." path="/admin" />
      <Navbar />
            ...
            {isLoading ? (
              ...
              <Card>
                <CardContent className="py-12 text-center text-muted-foreground">
                  No {tab === "all" ? "" : tab} verification requests found.
                </CardContent>
              </Card>
            ) : (
                    ...
                    <Card key={req.id}>
                          ...
                          <div className="flex items-center gap-3">
                            <Avatar className="h-10 w-10">
                              ...
                              <AvatarFallback className="bg-primary text-primary-foreground">
                                {req.profiles?.display_name?.[0]?.toUpperCase() || "U"}
                              </AvatarFallback>
                            </Avatar>
                            <div>
                      ...
                      <CardContent className="space-y-3">
                        <div className="flex items-center gap-2 text-sm font-medium">
                          ...
                          Level {req.level} — {levelCfg.label}
                        </div>
                        ...
                        <div className="grid gap-2 text-sm rounded-lg border p-3 bg-muted/30">
                          ...
                          {req.profiles && (
                            <div className="flex items-center gap-2">
                              ...
                              <span>{req.profiles.verification_level}</span>
                            </div>
                          )}
                        </div>
                          ...
                          <div className="space-y-3 pt-2">
                            ...
                            <div className="flex gap-2">
                              <Button
                                ...
                                onClick={() => handleReview(req.id, req.user_id, req.level, "approved")}
                              ...
                              <Button
                                variant="destructive"
                                className="flex-1 gap-1"
                                onClick={() => handleReview(req.id, req.user_id, req.level, "rejected")}
                                disabled={reviewMutation.isPending}
                              >
