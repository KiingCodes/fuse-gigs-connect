...
const Auth = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast.success("Account created! Welcome to Fuse Gigs! 🎉");
      navigate("/");
    }
  };
      ...
      <Card className="w-full max-w-md shadow-elevated">
        <CardHeader className="text-center">
          <div className="mx-auto mb-4">
            <img src={logo} alt="Fuse Gigs Logo" className="h-12 w-12 object-contain mx-auto" />
          </div>
          <CardTitle className="text-2xl font-bold">Fuse Gigs</CardTitle>
          <CardDescription>Discover & connect with your community</CardDescription>
        </CardHeader>
        <CardContent>
